...
public class StandaloneCartridge extends BaseCartridge implements IStandaloneCartridge {
	...
	public StandaloneCartridge(String name, URL url, String displayName, String description, List<String> tags) {
		super(name, url, displayName, description, tags);
	}

	public StandaloneCartridge(String name, String displayName,
			String description, List<String> tags) {
		// TODO Auto-generated constructor stub		
		super(name, null, displayName, description, tags);
	}
}