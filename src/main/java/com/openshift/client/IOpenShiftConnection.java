...
public interface IOpenShiftConnection {
	...
	/**
	 * Returns standaloneCartridgeUniqueTags
	 * 
	 * 
	 * @return getStandaloneCartridges tags unique
	 * 
	 * @see List<String>
	 * @see getStandaloneCartridges
	 */
	 ...
	 * </pre>
	 *
	 * @Method : getSearchTagStandaloneCartridges
	 * @Return : List<IStandaloneCartridge>
	 * @date   : 2014. 8. 7.
	 * @author : kikimans
	 * @history : 
	 * ------------------------------------------------------------------------------------------
